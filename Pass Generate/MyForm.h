...
namespace PassGenerate {
	...
	protected:
		/// <summary>
		/// Îñâîáîäèòü âñå èñ ïîëüçóåìûå ðåñóðñû.
		/// </summary>
		~MyForm()
		{
			if (components)
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->generate->Text = L"Ñãåíåðèðîâàòü";
			...
			this->label1->Text = L"Äîáðî ïîæàëîâàòü â ãåíåðàòîð ïàðîëÿ.\r\nÂû ìîæåòå âûáðàòü ïàðàìåòðû ãåíåðàöèè íàæàâ"
				L" íà ÷åê-áîêñû íèæå.";
			...
			this->label2->Text = L"Âûáåðèòå òèï ïàðàìåòðîâ";
			// 
			// custom
			// 
			...
			this->custom->Text = L"Íàñòðàèâàåìûå";
			...
			this->big->TabIndex = 5;
			this->big->Text = L"Çàãëàâíûå áóêâû (ABC)";
			...
			this->small->Text = L"Ñòðî÷íûå áóêâû (abc)";
			...
			this->specical->Text = L"Ñïåöèàëüíûå ñèìâîëû";
			...
			this->format->Text = L"Âûáåðèòå ôîðìàò";
			...
			this->label5->Text = L"Äëèíà ïàðîëÿ";
